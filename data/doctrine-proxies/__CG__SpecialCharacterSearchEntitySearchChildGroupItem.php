 ...
 */
class SearchChildGroupItem extends \SpecialCharacterSearch\Entity\SearchChildGroupItem implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'owner', 'resourceClass', 'resourceTemplate', 'isPublic', 'created', 'modified', 'values', 'media', 'siteBlockAttachments', 'searchItem', 'searchValues', 'parentItem', 'relatedItem', 'targetParentId'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SearchChildGroupItem $proxy) {
    ...
    public function getTargetParentId()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTargetParentId', []);

        return parent::getTargetParentId();
    }
    ...
    public function getRelatedItem()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRelatedItem', []);

        return parent::getRelatedItem();
    }
