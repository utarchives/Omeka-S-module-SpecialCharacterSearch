 ...
 */
class SearchValueItem extends \SpecialCharacterSearch\Entity\SearchValueItem implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'owner', 'resourceClass', 'resourceTemplate', 'isPublic', 'created', 'modified', 'values', 'media', 'siteBlockAttachments', 'searchValues'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SearchValueItem $proxy) {
