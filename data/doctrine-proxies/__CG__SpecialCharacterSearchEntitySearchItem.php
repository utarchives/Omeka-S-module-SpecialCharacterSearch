 ...
 */
class SearchItem extends \SpecialCharacterSearch\Entity\SearchItem implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'owner', 'resourceClass', 'resourceTemplate', 'isPublic', 'created', 'modified', 'values', 'media', 'siteBlockAttachments', 'searchValues', 'depth', 'parentItem', 'isParent', 'isHere', 'targetResourceClassId'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SearchItem $proxy) {
