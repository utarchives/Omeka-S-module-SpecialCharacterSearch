 ...
 */
class SearchChildItem extends \SpecialCharacterSearch\Entity\SearchChildItem implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'owner', 'resourceClass', 'resourceTemplate', 'isPublic', 'created', 'modified', 'values', 'media', 'siteBlockAttachments', 'searchValues', 'depth', 'parentItem', 'searchItem', 'relatedItem'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SearchChildItem $proxy) {
