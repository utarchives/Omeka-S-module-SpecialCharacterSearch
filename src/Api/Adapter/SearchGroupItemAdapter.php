...
use SpecialCharacterSearch\Api\Representation\SearchItemRepresentation;
use SpecialCharacterSearch\Entity\SearchGroupItem;
use SpecialCharacterSearch\Entity\SearchItem;


class SearchGroupItemAdapter extends AbstractSearchItemEntityAdapter
{
    /**
     * {@inheritDoc}
     */
    ...
    {
        return SearchItemRepresentation::class;
    }
...
//         $qb->andWhere("1=1)) ");
        ...
        ->select("$childItem.id")
        ->from(SearchGroupItem::class, $childItem);
